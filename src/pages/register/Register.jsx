      ...
      <div className="w-full max-w-sm p-6 m-auto mx-auto  rounded-lg shadow-md ">
        ...
        <form className="mt-6" onSubmit={handleSubmit(onSubmit)}>
          <div>
            ...
            <input type="text" name="name" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 mb-3" {...register("name", { required: true })} />
          </div>
          <div>
        ...
        <p className="mt-8 text-xs font-light text-center text-gray-400"> Already have an account? <Link to='/login' className="font-medium text-gray-700 dark:text-gray-200 hover:underline">Login here</Link></p>
      </div>
    </div>
  );
};
