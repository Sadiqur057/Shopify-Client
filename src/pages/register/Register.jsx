      ...
      <div className="w-full max-w-sm p-6 m-auto mx-auto  rounded-lg shadow-md ">
        ...
        <form className="mt-6" onSubmit={handleSubmit(onSubmit)}>
          <div>
            ...
            <input type="text" name="name" className="block w-full px-4 py-2 mt-2 text-gray-400 border border-gray-700 rounded-lg bg-dark focus:border-indigo-400 dark:focus:border-indigo-300 focus:ring-indigo-300 focus:outline-none focus:ring focus:ring-opacity-40 mb-3" {...register("name", { required: true })} />
          </div>
          <div>
