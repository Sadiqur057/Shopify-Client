    ...
    <div className="min-h-[calc(100vh-224px)] px-4 sm:px-10 py-3 bg-primary">
      <div className="w-full max-w-sm p-6 m-auto mx-auto  rounded-lg shadow-md ">
        ...
        <div className="flex items-center mt-6 -mx-2">
          <button onClick={handleGoogleLogin} type="button" className="flex items-center justify-center w-full px-6 py-2.5 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-primary rounded-lg hover:bg-indigo-400 focus:bg-indigo-400 focus:outline-none">
            Sign in with Google
          </button>
        </div>
